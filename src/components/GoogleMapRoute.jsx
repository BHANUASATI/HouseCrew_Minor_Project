...
const GoogleMapRoute = ({ 
  ...
  const calculateRouteInfo = () => {
    try {
      ...
      // In urban areas with obstacles (rivers, highways, restricted areas), 
      // driving distance can be 2-5x straight-line distance
      // Using a conservative multiplier of 3x for better estimation
      const estimatedDrivingDistance = straightLineDistance * 3;
      
      // Estimate travel time based on driving distance (assuming average speed of 25 km/h in city traffic)
      const estimatedTime = Math.ceil(estimatedDrivingDistance / 25 * 60);
      
      setRouteInfo({
        straightLineDistance: `${straightLineDistance.toFixed(1)} km`,
        estimatedDrivingDistance: `${estimatedDrivingDistance.toFixed(1)} km`,
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-4 max-w-sm mx-auto">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-blue-600">{routeInfo.straightLineDistance}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Est. Driving:</span>
                        <span className="font-medium text-purple-600">{routeInfo.estimatedDrivingDistance}</span>
                      </div>
                      <div className="flex justify-between">
                    ...
                    <p className="text-xs text-gray-500 mt-3 italic">
                      ⚠️ Use Google Maps for exact driving distance
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="bg-white rounded-lg p-3 space-y-2 text-sm">
                      ...
                      <div className="flex justify-between pt-2 border-t">
                        ...
                        <span className="font-bold text-blue-600">{routeInfo.straightLineDistance}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">Est. Driving Distance:</span>
                        <span className="font-bold text-purple-600">{routeInfo.estimatedDrivingDistance}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="bg-yellow-50 border border-yellow-200 rounded p-2 mt-2">
                        <p className="text-xs text-yellow-800">
                          ⚠️ <strong>Note:</strong> Estimated driving distance may vary. Click "Open Route in Google Maps" for exact distance and directions.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="bg-white rounded-lg p-3 space-y-3 text-sm">
                      <div>
                        <span className="text-gray-600 font-medium">Provider Location:</span>
                      ...
                      <div className="border-t pt-2">
                        <span className="text-gray-600 font-medium">Customer Location:</span>
                        <p className="text-gray-800 mt-1">
                          {customerAddress}
                        </p>
                        <p className="font-mono text-xs text-gray-500 mt-1">
