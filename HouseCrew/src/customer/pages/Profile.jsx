  ...
  return (
    <CustomerLayout>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        className="relative max-w-3xl bg-white rounded-2xl p-8
      ...
      >
        ...
        <div className="flex items-center gap-6 mb-8">
          <div className="relative">
            <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-indigo-200">
              {avatar ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-indigo-100 text-indigo-600 text-4xl">
                  <FaUser />
                </div>
              )}
            </div>
          ...
          <div>
            <h3 className="text-xl font-bold text-slate-700">Bhanu Asati</h3>
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="mt-8 px-8 py-3 rounded-xl text-white font-bold
          bg-gradient-to-r from-indigo-600 to-sky-500
